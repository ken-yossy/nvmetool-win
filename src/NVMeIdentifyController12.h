...
// Identify Controller data structure (v1.2.1) based on nvme.h
typedef struct {
    //
    ...
    uint8_t Reserved0[140];         // byte [ 239: 100]
    uint8_t Reserved1[16];          // byte [ 255: 240] Refer to the NVMe Management Interface Specification for definition
    ...
    uint8_t     Reserved2[4];       // byte [ 319: 316]

    uint16_t    KAS;                // byte [ 321: 320] M - Keep Alive Support (KAS)

    uint8_t     Reserved3[190];     // byte [ 511: 322]
    ...
    struct {
        ...
        uint32_t    Reserved2 : 11;                         // bit [31:21]
...
} NVME_IDENTIFY_CONTROLLER_DATA12, *PNVME_IDENTIFY_CONTROLLER_DATA12;
